...
## Output
The output of the game play are two .pdb (protein databank) files that can be viewed using PyMOL 'apt install pymol' or any other molecular visualisation software, you can upload the structure (here)[https://www.rcsb.org/3d-view] to view the molecules on a web browser 
